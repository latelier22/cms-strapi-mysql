...
export interface ApiCitationCitation extends Schema.CollectionType {
  ...
  attributes: {
    ...
    etat: Attribute.Enumeration<['brouillon', 'publi\u00E9e']> &
      Attribute.Required &
      Attribute.DefaultTo<'brouillon'>;
    parentCitationId: Attribute.Integer;
    photoId: Attribute.Media;
...
export interface ApiCommentComment extends Schema.CollectionType {
  ...
  attributes: {
    ...
    auteur: Attribute.String & Attribute.Required;
    etat: Attribute.Enumeration<['\u00E0 valider', 'valid\u00E9e']> &
      Attribute.Required &
      Attribute.DefaultTo<'\u00E0 valider'>;
    post: Attribute.Relation<
      'api::comment.comment',
      'manyToOne',
      'api::post.post'
    >;
    child_comments: Attribute.Relation<
      'api::comment.comment',
      'oneToMany',
      'api::comment.comment'
    >;
...
export interface ApiPicturePicture extends Schema.CollectionType {
  ...
  attributes: {
    imported: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    photoId: Attribute.Integer & Attribute.Required;
    fileId: Attribute.Integer & Attribute.Required;
    importedAt: Attribute.DateTime;
...
export interface ApiPostPost extends Schema.CollectionType {
  ...
  attributes: {
    ...
    etat: Attribute.Enumeration<['publi\u00E9e', 'brouillon']> &
      Attribute.Required &
      Attribute.DefaultTo<'brouillon'>;
...
export interface ApiTagTag extends Schema.CollectionType {
  ...
  attributes: {
    ...
    mainTag: Attribute.Boolean & Attribute.DefaultTo<false>;
    parent_id: Attribute.Relation<'api::tag.tag', 'manyToOne', 'api::tag.tag'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
